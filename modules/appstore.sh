...
linux_app() {
	...
	while true; do
		...
		docker_tato
		echo -e "${pink}------------------------------------------------------------------------------------${white}"
		echo -e "${cyan}1.   ${white}$(pad_right "1Panel面板 $(_dot 1)" 34) ${cyan}2.   ${white}$(pad_right "宝塔面板 $(_dot 2)" 34) ${cyan}3.   ${white}$(pad_right "aaPanel面板 $(_dot 3)" 34)"
		echo -e "${cyan}4.   ${white}$(pad_right "NginxProxyManager面板 $(_dot 4)" 34) ${cyan}5.   ${white}$(pad_right "OpenList面板 $(_dot 5)" 34) ${cyan}6.   ${white}$(pad_right "WebTop远程桌面网页版 $(_dot 6)" 34)"
		echo -e "${cyan}7.   ${white}$(pad_right "Komari监控 $(_dot 7)" 34) ${cyan}8.   ${white}$(pad_right "qbittorrent离线下载 $(_dot 8)" 34) ${cyan}9.   ${white}$(pad_right "Poste.io邮件服务器程序 $(_dot 9)" 34)"
		echo -e "${cyan}10.  ${white}$(pad_right "青龙面板 $(_dot 10)" 34) ${cyan}11.  ${white}$(pad_right "Code-Server(网页vscode) $(_dot 11)" 34) ${cyan}12.  ${white}$(pad_right "Looking Glass(测速面板) $(_dot 12)" 34)"
		echo -e "${cyan}13.  ${white}$(pad_right "雷池WAF防火墙面板 $(_dot 13)" 34) ${cyan}14.  ${white}$(pad_right "onlyoffice在线办公OFFICE $(_dot 14)" 34) ${cyan}15.  ${white}$(pad_right "UptimeKuma监控工具 $(_dot 15)" 34)"
		echo -e "${cyan}16.  ${white}$(pad_right "Memos网页备忘录 $(_dot 16)" 34) ${cyan}17.  ${white}$(pad_right "drawio免费的在线图表软件 $(_dot 17)" 34) ${cyan}18.  ${white}$(pad_right "Sun-Panel导航面板 $(_dot 18)" 34)"
		echo -e "${cyan}19.  ${white}$(pad_right "webssh网页版SSH连接工具 $(_dot 19)" 34) ${cyan}20.  ${white}$(pad_right "LobeChatAI聊天聚合网站 $(_dot 20)" 34) ${cyan}21.  ${white}$(pad_right "MyIP工具箱 $(_dot 21)" 34)"
		echo -e "${cyan}22.  ${white}$(pad_right "ghproxy(GitHub加速站) $(_dot 22)" 34) ${cyan}23.  ${white}$(pad_right "AllinSSL证书管理平台 $(_dot 23)" 34) ${cyan}24.  ${white}$(pad_right "DDNS-GO $(_dot 24)" 34)"
		echo -e "${cyan}25.  ${white}$(pad_right "Lucky $(_dot 25)" 34) ${cyan}26.  ${white}$(pad_right "LibreTV私有影视 $(_dot 26)" 34) ${cyan}27.  ${white}$(pad_right "MoonTV私有影视 $(_dot 27)" 34)"
		echo -e "${cyan}28.  ${white}$(pad_right "Melody音乐精灵 $(_dot 28)" 34) ${cyan}29.  ${white}$(pad_right "Beszel服务器监控 $(_dot 29)" 34) ${cyan}30.  ${white}$(pad_right "SyncTV一起看片神器 $(_dot 30)" 34)"
		echo -e "${cyan}31.  ${white}$(pad_right "X-UI面板 $(_dot 31)" 34) ${cyan}32.  ${white}$(pad_right "3X-UI面板 $(_dot 32)" 34) ${cyan}33.  ${white}$(pad_right "Microsoft 365 E5 Renew X $(_dot 33)" 34)"
		echo -e "${cyan}34.  ${white}$(pad_right "DecoTV私有影视 $(_dot 34)" 34) ${cyan}35.  ${white}$(pad_right "Drawnix在线白板 $(_dot 35)" 34)"
		echo -e "${pink}------------------------------------------------------------------------------------${white}"
		echo -e "${cyan}36.  ${white}$(pad_right "Portainer容器管理 $(_dot 36)" 34) ${cyan}37.  ${white}$(pad_right "Cloudreve网盘 $(_dot 37)" 34) ${cyan}38.  ${white}$(pad_right "Nextcloud私有网盘 $(_dot 38)" 34)"
		echo -e "${cyan}39.  ${white}$(pad_right "emby媒体管理 $(_dot 39)" 34) ${cyan}40.  ${white}$(pad_right "jellyfin媒体管理 $(_dot 40)" 34) ${cyan}41.  ${white}$(pad_right "AdGuardHome去广告 $(_dot 41)" 34)"
		echo -e "${cyan}42.  ${white}$(pad_right "Navidrome音乐服务器 $(_dot 42)" 34) ${cyan}43.  ${white}$(pad_right "Vaultwarden密码管理 $(_dot 43)" 34) ${cyan}44.  ${white}$(pad_right "StirlingPDF工具大全 $(_dot 44)" 34)"
		echo -e "${cyan}45.  ${white}$(pad_right "Speedtest测速面板 $(_dot 45)" 34) ${cyan}46.  ${white}$(pad_right "PhotoPrism私有相册 $(_dot 46)" 34) ${cyan}47.  ${white}$(pad_right "searxng聚合搜索 $(_dot 47)" 34)"
		echo -e "${cyan}48.  ${white}$(pad_right "Pingvin-Share文件分享 $(_dot 48)" 34) ${cyan}49.  ${white}$(pad_right "Dockge容器管理 $(_dot 49)" 34) ${cyan}50.  ${white}$(pad_right "it-tools工具箱 $(_dot 50)" 34)"
		echo -e "${cyan}51.  ${white}$(pad_right "n8n自动化工作流 $(_dot 51)" 34) ${cyan}52.  ${white}$(pad_right "OpenWebUI自托管AI $(_dot 52)" 34) ${cyan}53.  ${white}$(pad_right "Dify大模型知识库 $(_dot 53)" 34)"
		echo -e "${cyan}54.  ${white}$(pad_right "gitea私有代码仓库 $(_dot 54)" 34) ${cyan}55.  ${white}$(pad_right "FileBrowser文件管理 $(_dot 55)" 34) ${cyan}56.  ${white}$(pad_right "FRP内网穿透(服务端) $(_dot 56)" 34)"
		echo -e "${cyan}57.  ${white}$(pad_right "WireGuard组网(服务端) $(_dot 57)" 34) ${cyan}58.  ${white}$(pad_right "JumpServer堡垒机 $(_dot 58)" 34) ${cyan}59.  ${white}$(pad_right "immich图片视频管理 $(_dot 59)" 34)"
		echo -e "${cyan}60.  ${white}$(pad_right "Syncthing文件同步 $(_dot 60)" 34) ${cyan}61.  ${white}$(pad_right "Umami网站统计 $(_dot 61)" 34) ${cyan}62.  ${white}$(pad_right "思源笔记 $(_dot 62)" 34)"
		echo -e "${cyan}63.  ${white}$(pad_right "SFTPGo文件传输 $(_dot 63)" 34) ${cyan}64.  ${white}$(pad_right "Owncast自托管直播 $(_dot 64)" 34) ${cyan}65.  ${white}$(pad_right "Deepseek AI大模型 $(_dot 65)" 34)"
		echo -e "${cyan}66.  ${white}$(pad_right "RocketChat聊天系统 $(_dot 66)" 34) ${cyan}67.  ${white}$(pad_right "Gopeed高速下载 $(_dot 67)" 34) ${cyan}68.  ${white}$(pad_right "2FAuth二步验证器 $(_dot 68)" 34)"
		echo -e "${cyan}69.  ${white}$(pad_right "ZFile在线网盘 $(_dot 69)" 34) ${cyan}70.  ${white}$(pad_right "Nexterm远程连接 $(_dot 70)" 34) ${cyan}71.  ${white}$(pad_right "JitsiMeet视频会议 $(_dot 71)" 34)"
		echo -e "${cyan}72.  ${white}$(pad_right "Stream四层代理转发 $(_dot 72)" 34) ${cyan}73.  ${white}$(pad_right "FileCodeBox文件快递 $(_dot 73)" 34) ${cyan}74.  ${white}$(pad_right "Matrix去中心化聊天 $(_dot 74)" 34)"
		echo -e "${cyan}75.  ${white}$(pad_right "yt-dlp视频下载 $(_dot 75)" 34) ${cyan}76.  ${white}$(pad_right "paperless文档管理 $(_dot 76)" 34) ${cyan}77.  ${white}$(pad_right "Wallos财务管理 $(_dot 77)" 34)"
		echo -e "${cyan}78.  ${white}$(pad_right "PairDrop文件传输 $(_dot 78)" 34) ${cyan}79.  ${white}$(pad_right "Dufs静态文件服务器 $(_dot 79)" 34) ${cyan}80.  ${white}$(pad_right "PandaWiki文档管理 $(_dot 80)" 34)"
		echo -e "${cyan}81.  ${white}$(pad_right "linkwarden书签管理 $(_dot 81)" 34) ${cyan}82.  ${white}$(pad_right "VoceChat聊天系统 $(_dot 82)" 34) ${cyan}83.  ${white}$(pad_right "Karakeep书签管理 $(_dot 83)" 34)"
		echo -e "${cyan}84.  ${white}$(pad_right "NewAPI大模型资产管理 $(_dot 84)" 34) ${cyan}85.  ${white}$(pad_right "RAGFlow知识库 $(_dot 85)" 34) ${cyan}86.  ${white}$(pad_right "AstrBot聊天机器人 $(_dot 86)" 34)"
		echo -e "${cyan}87.  ${white}$(pad_right "LangBot聊天机器人 $(_dot 87)" 34) ${cyan}88.  ${white}$(pad_right "多格式文件转换 $(_dot 88)" 34) ${cyan}89.  ${white}$(pad_right "LibreSpeed测速 $(_dot 89)" 34)"
		echo -e "${cyan}90.  ${white}$(pad_right "gpt-load AI透明代理 $(_dot 90)" 34) ${cyan}91.  ${white}$(pad_right "补货监控工具 $(_dot 91)" 34) ${cyan}92.  ${white}$(pad_right "PVE虚拟化管理 $(_dot 92)" 34)"
		echo -e "${cyan}93.  ${white}$(pad_right "DSM群晖虚拟机 $(_dot 93)" 34) ${cyan}94.  ${white}$(pad_right "在线DOS老游戏 $(_dot 94)" 34) ${cyan}95.  ${white}$(pad_right "迅雷离线下载 $(_dot 95)" 34)"
		echo -e "${cyan}96.  ${white}$(pad_right "小雅Alist全家桶 $(_dot 96)" 34) ${cyan}97.  ${white}$(pad_right "Bililive直播录制 $(_dot 97)" 34) ${cyan}98.  ${white}$(pad_right "极简朋友圈 $(_dot 98)" 34)"
		echo -e "${cyan}99.  ${white}$(pad_right "PanSou网盘搜索 $(_dot 99)" 34) ${cyan}100. ${white}$(pad_right "简单图床lskypro $(_dot 100)" 34) ${cyan}101. ${white}$(pad_right "禅道项目管理 $(_dot 101)" 34)"
		echo -e "${cyan}102. ${white}$(pad_right "QD-Today定时任务 $(_dot 102)" 34) ${cyan}103. ${white}$(pad_right "耗子管理面板 $(_dot 103)" 34) ${cyan}104. ${white}$(pad_right "AMH建站面板 $(_dot 104)" 34)"
		echo -e "${cyan}105. ${white}$(pad_right "在线翻译服务器 $(_dot 105)" 34) ${cyan}106. ${white}$(pad_right "AI视频生成工具 $(_dot 106)" 34) ${cyan}107. ${white}$(pad_right "RustDesk远程桌面 $(_dot 107)" 34)"
		echo -e "${cyan}108. ${white}$(pad_right "Firefox浏览器 $(_dot 108)" 34) ${cyan}109. ${white}$(pad_right "DPanel容器管理 $(_dot 109)" 34) ${cyan}110. ${white}$(pad_right "普罗米修斯监控 $(_dot 110)" 34)"
		echo -e "${pink}------------------------------------------------------------------------------------${white}"
